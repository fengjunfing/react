      ...
      <CommonSearchForm {...this.props}>
        ...
        <FormItem>
          <Input addonBefore={'应用名称'} className={'inputSelect'} addonAfter=
            {getFieldDecorator('appId')(
              <Select style={{ minWidth: 90 }} loading={this.props.appIdLoading} dropdownMatchSelectWidth={false} dropdownStyle={{ maxWidth: 200 }}>
                {
        ...
        <FormItem>
          {getFieldDecorator('name', {
            ...
            <Input addonBefore={'名称'} placeholder={'例如：超级管理员'} />
          )}
        </FormItem>
      </CommonSearchForm>
    );
