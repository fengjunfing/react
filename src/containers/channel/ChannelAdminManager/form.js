...
import ThisForm from '@/components/channel/ChannelAdminManager/form';

class ContainersChannelAdminManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersChannelAdminManagerForm);
