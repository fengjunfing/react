...
import ThisForm from '@/components/channel/CommodityQuery/form';

class ContainersCommodityQueryForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersCommodityQueryForm);
