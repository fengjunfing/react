...
import ThisTable from '@/components/channel/CommodityQuery/table';

class ContainersCommodityQueryTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersCommodityQueryTable);
