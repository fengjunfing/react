...
import ThisSearchForm from '@/components/channel/ChannelManager/searchForm';

class ContainersChannelManagerSearch extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersChannelManagerSearch);
