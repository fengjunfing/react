...
import ThisTable from '@/components/cars/ModelManager/table';

class ContainersModelManagerTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersModelManagerTable);
