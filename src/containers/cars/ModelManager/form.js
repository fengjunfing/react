...
import ThisForm from '@/components/cars/ModelManager/form';

class ContainersModelManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersModelManagerForm);
