...
import ThisForm from '@/components/cars/BrandsManager/form';

class ContainersBrandsManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersBrandsManagerForm);
