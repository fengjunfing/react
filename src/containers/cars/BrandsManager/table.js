...
import ThisTable from '@/components/cars/BrandsManager/table';

class ContainersBrandsManagerTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersBrandsManagerTable);
