...
import ThisForm from '@/components/cars/SeriesManager/form';

class ContainersSeriesManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersSeriesManagerForm);
