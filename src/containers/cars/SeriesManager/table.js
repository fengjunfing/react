...
import ThisTable from '@/components/cars/SeriesManager/table';

class ContainersSeriesManagerTable extends BaseComponent {
  static propTypes = {
...
const mapStateToProps = state => {
  const data = state.getIn(['cars', 'seriesManager']);
  return {
...
const methods = Actions.SERIES_MANAGER;
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersSeriesManagerTable);
