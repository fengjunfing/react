...
import ThisTable from '@/components/basis/ChannelSerTypeConf/table';

class ContainersChannelSerTypeConfTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersChannelSerTypeConfTable);
