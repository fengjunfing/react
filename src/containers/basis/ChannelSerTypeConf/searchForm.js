...
import ThisSearchForm from '@/components/basis/ChannelSerTypeConf/searchForm';

class ContainersChannelSerTypeConfSearch extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersChannelSerTypeConfSearch);
