...
import ThisForm from '@/components/basis/ChannelSerTypeConf/form';

class ContainersChannelSerTypeConfForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersChannelSerTypeConfForm);
