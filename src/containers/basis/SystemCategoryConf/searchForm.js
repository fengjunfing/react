...
import ThisSearchForm from '@/components/basis/SystemCategoryConf/searchForm';

class ContainersSystemCategoryConfSearch extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersSystemCategoryConfSearch);
