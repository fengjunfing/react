...
import ThisForm from '@/components/basis/SystemCategoryConf/form';

class ContainersSystemCategoryConfForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersSystemCategoryConfForm);
