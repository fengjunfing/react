...
import ThisForm from '@/components/basis/MaintenanceProConf/form';

class ContainersMaintenanceProConfForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersMaintenanceProConfForm);
