...
import ThisTable from '@/components/basis/MaintenanceProConf/table';

class ContainersMaintenanceProConfTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersMaintenanceProConfTable);
