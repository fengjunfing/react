...
import ThisBtns from '@/components/basis/MaintenanceProConf/btns';

class ContainersMaintenanceProConfBtns extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersMaintenanceProConfBtns);
