...
import ThisSearchForm from '@/components/basis/MortgageFreeManager/searchForm';

class ContainersMortgageFreeManagerSearch extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersMortgageFreeManagerSearch);
