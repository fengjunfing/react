...
import ThisForm from '@/components/basis/MortgageFreeManager/form';

class ContainersMortgageFreeManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersMortgageFreeManagerForm);
