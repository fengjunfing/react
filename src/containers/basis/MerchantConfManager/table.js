...
import ThisTable from '@/components/basis/MerchantConfManager/table';

class ContainersMerchantConfManagerTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersMerchantConfManagerTable);
