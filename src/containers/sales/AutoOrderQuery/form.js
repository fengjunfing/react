...
import ThisForm from '@/components/sales/AutoOrderQuery/form';

class ContainersAutoOrderQueryForm extends BaseComponent {
  static propTypes = {
...
const mapStateToProps = state => {
  ...
  const refundQuery = state.getIn(['sales', 'refundQuery']);
  return {
    ...
    RQ_SearchData: refundQuery.getIn(['table', 'searchData']),
  };
};

const methods = Actions.AUTO_ORDER_QUERY;
const REFUND_QUERY = Actions.REFUND_QUERY;
...
const mapDispatchToProps = {
  ...
  RQ_TableGet: REFUND_QUERY.tableGet,
  RQ_FormReset: REFUND_QUERY.formReset,
  RQ_FormGet: REFUND_QUERY.formGet,
  RQ_FormShow: REFUND_QUERY.formShow,
};

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ContainersAutoOrderQueryForm));
