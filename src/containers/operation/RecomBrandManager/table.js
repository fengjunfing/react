...
import ThisTable from '@/components/operation/RecomBrandManager/table';

class ContainersRecomBrandManagerTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersRecomBrandManagerTable);
