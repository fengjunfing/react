...
import ThisForm from '@/components/operation/RecomBrandManager/form';

class ContainersRecomBrandManagerForm extends BaseComponent {
  static propTypes = {
...
const mapStateToProps = state => {
  ...
  return {
    ...
    cbList: data.getIn(['form', 'cbList']),
  };
};

const methods = Actions.RECOM_BRAND_MANAGER;
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersRecomBrandManagerForm);
