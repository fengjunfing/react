...
import ThisTable from '@/components/operation/GroupManager/name-table-right';

class ContainersGroupManagerNameTableRight extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersGroupManagerNameTableRight);
