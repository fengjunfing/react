...
import ThisTable from '@/components/operation/GroupManager/table';

class ContainersGroupManagerTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersGroupManagerTable);
