...
import ThisForm from '@/components/operation/HomeActivityManager/form';

class ContainersHomeActivityManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersHomeActivityManagerForm);
