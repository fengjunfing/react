...
import ThisTable from '@/components/operation/HomeActivityManager/table';

class ContainersHomeActivityManagerTable extends BaseComponent {
  static propTypes = {
...
const methods = Actions.HOME_ACTIVITY_MANAGER;
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersHomeActivityManagerTable);
