...
import ThisTable from '@/components/operation/CarouselManager/table';

class ContainersCarouselManagerTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersCarouselManagerTable);
