...
import ThisSearchForm from '@/components/operation/CarouselManager/searchForm';

class ContainersCarouselManagerSearch extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersCarouselManagerSearch);
