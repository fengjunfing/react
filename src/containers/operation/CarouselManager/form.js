...
import ThisForm from '@/components/operation/CarouselManager/form';

class ContainersCarouselManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersCarouselManagerForm);
