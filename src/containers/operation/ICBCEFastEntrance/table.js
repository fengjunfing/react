...
import ThisTable from '@/components/operation/ICBCEFastEntrance/table';

class ContainersICBCEFastEntranceTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersICBCEFastEntranceTable);
