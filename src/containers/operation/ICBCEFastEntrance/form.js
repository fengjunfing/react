...
import ThisForm from '@/components/operation/ICBCEFastEntrance/form';

class ContainersICBCEFastEntranceForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersICBCEFastEntranceForm);
