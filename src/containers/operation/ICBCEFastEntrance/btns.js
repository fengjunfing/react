...
import ThisBtns from '@/components/operation/ICBCEFastEntrance/btns';

class ContainersICBCEFastEntranceBtns extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersICBCEFastEntranceBtns);
