...
import ThisSearchForm from '@/components/operation/ICBCEGroupManager/searchForm';

class ContainersICBCEGroupManagerSearch extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersICBCEGroupManagerSearch);
