...
import ThisForm from '@/components/operation/ICBCEGroupManager/leftsForm';

class ContainersICBCEGroupManagerForm extends BaseComponent {
  static propTypes = {
    ...
    this.form.validateFields((err, values) => {
      if (!err) {
        ...
        this.props.submit(formData).then(res => {
          const groupId = res.get('data').get('id');
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersICBCEGroupManagerForm);
