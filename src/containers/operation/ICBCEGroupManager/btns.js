...
import ThisBtns from '@/components/operation/ICBCEGroupManager/btns';

class ContainersICBCEGroupManagerBtns extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersICBCEGroupManagerBtns);
