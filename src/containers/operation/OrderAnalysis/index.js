...
import ThisIndex from '@/components/operation/OrderAnalysis';
import Actions from '@/actions';
import moment from 'moment';

class ContainersOrderAnalysis extends BaseComponent {
  constructor (props) {
    super(props);
    this.map_count = null;
...
const mapStateToProps = state => {
  const data = state.getIn(['operation', 'orderAnalysis']);
  return {
...
const methods = Actions.ORDER_ANALYSIS;
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersOrderAnalysis);
