...
import ThisTable from '@/components/operation/SCCarouselManager/table';

class ContainersSCCarouselManagerTable extends BaseComponent {
  static propTypes = {
...
const mapStateToProps = state => {
  ...
  const data = state.getIn(['operation', 'sccarouselManager']);
  return {
...
const methods = Actions.SC_CAROUSEL_MANAGER;
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersSCCarouselManagerTable);
