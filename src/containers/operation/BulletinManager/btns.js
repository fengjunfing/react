...
import ThisBtns from '@/components/operation/BulletinManager/btns';

class ContainersBulletinManagerBtns extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersBulletinManagerBtns);
