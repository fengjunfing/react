...
import ThisForm from '@/components/operation/BulletinManager/form';

class ContainersBulletinManagerForm extends BaseComponent {
  static propTypes = {
    ...
    this.form.validateFields((err, values) => {
      if (!err) {
        ...
        if (formData.effectiveDate) {
          formData.effectiveDate = formData.effectiveDate.format('YYYY-MM-DD');
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersBulletinManagerForm);
