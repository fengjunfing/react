...
import ThisForm from '@/components/operation/SCRecomBrandManager/form';

class ContainersSCRecomBrandManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersSCRecomBrandManagerForm);
