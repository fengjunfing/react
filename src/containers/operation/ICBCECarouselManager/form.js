...
import ThisForm from '@/components/operation/ICBCECarouselManager/form';

class ContainersICBCECarouselManagerForm extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersICBCECarouselManagerForm);
