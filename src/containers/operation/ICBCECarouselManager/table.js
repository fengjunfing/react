...
import ThisTable from '@/components/operation/ICBCECarouselManager/table';

class ContainersICBCECarouselManagerTable extends BaseComponent {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersICBCECarouselManagerTable);
