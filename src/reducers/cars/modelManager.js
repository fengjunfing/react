...
const searchForm = (state = searchFormInitState, action) => {
  switch (action.type) {
  case thunkTypes.getCarBrandsList.REQUESTTYPE:
    return state
      .set('loading', true);
  case thunkTypes.getCarBrandsList.SUCCESSTYPE:
    return state
      .set('loading', false)
      .set('brandsList', action.response.get('result'));
  case thunkTypes.getCarBrandsList.FAILURETYPE:
    return state
      .set('loading', false);
  case thunkTypes.getCarSeriesList.REQUESTTYPE:
    return state
      .set('loading', true);
  case thunkTypes.getCarSeriesList.SUCCESSTYPE:
    return state
      .set('loading', false)
      .set('seriesList', action.response.get('result'));
  case thunkTypes.getCarSeriesList.FAILURETYPE:
    return state
      .set('loading', false);
  default:
    return state;
