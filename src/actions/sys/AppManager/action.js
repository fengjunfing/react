...
const action = {
  ...
  SINGLE_IMAGE_MODAL_RESET: THISACTION + 'SINGLE_IMAGE_MODAL_RESET',
  SINGLE_IMAGE_MODAL_SETDATA: THISACTION + 'SINGLE_IMAGE_MODAL_SETDATA',
  SINGLE_IMAGE_MODAL_SHOW: THISACTION + 'SINGLE_IMAGE_MODAL_SHOW',
  SINGLE_IMAGE_MODAL_HIDE: THISACTION + 'SINGLE_IMAGE_MODAL_HIDE',
};
...
const singleImageModalReset = () => dispatch => dispatch({
  type: action.SINGLE_IMAGE_MODAL_RESET,
});

const singleImageModalSetData = data => dispatch => dispatch({
  type: action.SINGLE_IMAGE_MODAL_SETDATA,
  data,
});

const singleImageModalShow = title => dispatch => dispatch({
  type: action.SINGLE_IMAGE_MODAL_SHOW,
  title,
});

const singleImageModalHide = () => dispatch => dispatch({
  type: action.SINGLE_IMAGE_MODAL_HIDE,
});
...
export default {
  ...
  singleImageModalReset,
  singleImageModalSetData,
  singleImageModalShow,
  singleImageModalHide,
};