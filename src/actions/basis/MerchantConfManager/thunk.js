...
const tableDelete = params => dispatch => dispatch({
  [THISACTION + 'TABLE_DELETE']: {
    ...
    url: 'sysMerchantConfig/deleteByServiceId',
    params,
  }
});
...
const tablePublish = params => dispatch => dispatch({
  [THISACTION + 'TABLE_PUBLISH']: {
    ...
    url: 'sysMerchantConfig/enableMerchantConfig',
    params,
  }
});
...
const tableUnpublish = params => dispatch => dispatch({
  [THISACTION + 'TABLE_UNPUBLISH']: {
    ...
    url: 'sysMerchantConfig/disableMerchantConfig',
    params,
  }
});
...
const formGet = params => dispatch => dispatch({
  [THISACTION + 'FORM_GET']: {
    ...
    url: 'sysMerchantConfig/selectByPrimaryKey',
    params,
  }
});
...
const formAddSubmit = params => ({
  [THISACTION + 'FORM_ADD_SUBMIT']: {
    ...
    url: 'sysMerchantConfig/insertSelective',
    params,
  }
});
...
const formEditSubmit = params => ({
  [THISACTION + 'FORM_EDIT_SUBMIT']: {
    types: Object.values(thunk.formSubmit),
    url: 'sysMerchantConfig/updateRoleListByServiceId',
    params,
  }
});
...
const queryRoleList = () => ({
  [THISACTION + 'QUERY_ROLE_LIST']: {
    types: Object.values(thunk.queryRoleList),
    url: 'sysMerchantConfig/queryRoleList',
  }
});
